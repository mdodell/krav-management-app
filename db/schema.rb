...
ActiveRecord::Schema[8.1].define(version: 2025_11_04_120200) do
  ...
  create_table "sessions", force: :cascade do |t|
    ...
    t.index ["gym_id", "user_id"], name: "index_sessions_on_gym_id_and_user_id"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["gym_id", "email"], name: "index_users_on_gym_id_and_email", unique: true
